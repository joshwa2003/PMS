...
import { Work as WorkIcon, MoreVert as MoreVertIcon } from '@mui/icons-material';
...
const AppliedJobs = () => {
  const { studentJobs, studentJobsLoading, studentJobsError, fetchStudentJobs } = useJob();
  const [appliedJobs, setAppliedJobs] = useState([]);
  const [tabValue, setTabValue] = useState(2); // Default to "Applied" tab
      ...
      <MDBox py={3}>
        <Container maxWidth="xl">
          ...
          >
                  ...
                  '& .MuiTab-root': {
                    ...
                    '&.Mui-selected': {
                      ...
                      backgroundColor: tabValue === 0 ? 'rgba(0,0,0,0.08)' : 
                                      tabValue === 1 ? 'rgba(0,0,0,0.08)' : 
                                      tabValue === 2 ? '#2e7d32' : 
                                      tabValue === 3 ? 'rgba(0,0,0,0.08)' : 'rgba(0,0,0,0.08)',
                    },
                    '&:hover': {
                      backgroundColor: tabValue === 2 && tabValue === 2 ? '#2e7d32' : 'rgba(0,0,0,0.04)',
                      opacity: 0.9
                    }
                  }
                }}
            ...
            {tabValue === 2 && appliedJobs.length === 0 ? (
              <MDBox 
                display="flex" 
              ...
              <MDBox>
                {tabValue === 2 && appliedJobs.map((job) => (
                  <Box 
                    key={job._id}
