...
/**
 * Placement Director Profile Sidenav - Dedicated sidebar for placement director profile pages
 * Replaces the main sidebar when in placement director profile section
 */
function PlacementDirectorProfileSidenav({ color, brand, brandName, ...rest }) {
        ...
        <MDBox component={Link} to="/" display="flex" alignItems="center">
          ...
          >
            <MDTypography component="h6" variant="button" fontWeight="medium" color={textColor}>
              {brandName || "Placement Director Profile"}
            </MDTypography>
          </MDBox>
        </MDBox>
      </MDBox>
...
// Setting default values for the props of PlacementDirectorProfileSidenav
PlacementDirectorProfileSidenav.defaultProps = {
  color: "info",
  brand: "",
};

// Typechecking props for the PlacementDirectorProfileSidenav
PlacementDirectorProfileSidenav.propTypes = {
  color: PropTypes.oneOf(["primary", "secondary", "info", "success", "warning", "error", "dark"]),
  brand: PropTypes.string,
  brandName: PropTypes.string,
};

export default PlacementDirectorProfileSidenav;
